# --- Terraform Variables: configuration for the infrastructure ---
# --- Variables de Terraform: configuración de la infraestructura ---
...
# --- VPC CIDR ---
# --- Bloque CIDR principal de la VPC ---
variable "vpc_cidr" {
...
# --- Availability Zones ---
# --- Zonas de disponibilidad donde se despliega la infraestructura ---
...
# --- Subnet CIDRs for private subnets ---
# --- Bloques CIDR de las subredes privadas ---
...
# --- Port for the application and database ---
# --- Puerto para la aplicación y la base de datos ---
variable "app_port" {
...
# --- Type of EC2 instance for the Auto Scaling Group ---
# --- Tipo de instancia EC2 para el Auto Scaling Group ---
